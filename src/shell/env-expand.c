                       ...
                       void *data)
{
    ...
    json_object_foreach_safe (to_expand, tmp, key, value) {
        ...
        /*  If mustache render was successful, then remove this key from
         *  env-expand in jobspec object internally, so it isn't expanded
         *  again in task_env_expand(), then set env variable:
         */
