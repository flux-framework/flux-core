 ...
 * It was copied verbatim from the MPICH source tree.
 *
 * The Flux library that provides PMI distributed under the terms of
 * the GNU Lesser General Public License; either version
