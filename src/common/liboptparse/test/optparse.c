...
Usage: prog-foo [OPTIONS]\n\
  ...
  -t, --test             Enable a test option.\n",
    ...
    opt = ((struct optparse_option){.name = "hidden",
                                    .key = 'H',
                                    .has_arg = 1,
...
This is some doc for group 1\n\
  ...
  -C, --option-C              ThisOptionHasAVeryLongWordInTheDescriptionThatShouldBeBrokenAcrossLines.\n",
    ...
    opt = ((struct optparse_option){.name = "long-only",
                                    .group = 1,
...
void test_errors (void)
{
    ...
    opt = ((struct optparse_option){.name = "help",
                                    .key = 'h',
...
void test_long_only (void)
{
    ...
    struct optparse_option opts[] = {
        {.name = "basic",
         ...
         .has_arg = 1,
         .arginfo = "B",
         .usage = "This is a basic argument"},
        {.name = "long-only",
         .has_arg = 1,
         .arginfo = "L",
         .usage = "This is a long-only option"},
        {.name = "again-long-only", .has_arg = 0, .usage = "Another long-only"},
        OPTPARSE_TABLE_END,
    };

    char *av[] = {"long-only-test", "-b", "one", "--again-long-only", NULL};
    int ac = sizeof (av) / sizeof (av[0]) - 1;
    int optindex;
...
void test_optional_argument (void)
{
    ...
    struct optparse_option opts[] = {
        ...
        {.name = "optional-arg",
         ...
         .key = 'o',
         .arginfo = "OPTIONAL",
         .usage = "This has an optional argument"},
        OPTPARSE_TABLE_END,
    };

    char *av[] = {"optarg", "--optional-arg", "extra-args", NULL};
    int ac = sizeof (av) / sizeof (av[0]) - 1;
    int optindex;
    ...
    char *av2[] = {"optarg", "--optional-arg=foo", "extra-args", NULL};
    ac = sizeof (av2) / sizeof (av2[0]) - 1;
