...
static struct flux_watcher_ops fd_watcher = {.start = fd_start,
                                             .stop = fd_stop,
                                             .destroy = NULL};
                                                 ...
                                                 void *arg)
{
    ...
    if (ev_buffer_read_init (ebr, fd, size, buffer_read_cb, r->loop) < 0)
        goto cleanup;
                                                  ...
                                                  void *arg)
{
    ...
    if (ev_buffer_write_init (ebw, fd, size, buffer_write_cb, r->loop) < 0)
        goto cleanup;
