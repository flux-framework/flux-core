 ...
 * (https://github.com/zeromq/czmq/issues/2173) a localized copy was
 * made instead of waiting for OS distros to pick up the bug fix.
 *
 * This file is a verbatim copy with only minor adjustments included
 * headers.
 */
