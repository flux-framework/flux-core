...
void simple (void)
{
    ...
    ok (rc == 0 && userid == 1000 && payloadsz == 4
...
void decode_bad_header (void)
{
    ...
    /* extra foo field */
    const char bad4_header[] =
        "foo\0i0\0version\0i1\0userid\0i1000\0mech\0snone";
...
{
    const char *good =
        "dmVyc2lvbgBpMQB1c2VyaWQAaTEwMDAAbWVjaABzbm9uZQA=.Zm9vAA==.none";
    /* wrong suffix */
    const char *bad1 =
    ...
    const char *bad4 =
        "dmVyc2lvbgBpMQB1c2VyaWQAaTEwMDAAbWVjaABzbm9uZQA=.%m9vAA==.none";
    /* invalid base64 header (% character) */
    const char *bad5 =
        "%mVyc2lvbgBpMQB1c2VyaWQAaTEwMDAAbWVjaABzbm9uZQA=.Zm9vAA==.none";
