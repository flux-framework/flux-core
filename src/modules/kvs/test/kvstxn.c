...
void kvstxn_process_follow_symlink_no_namespace (void)
{
    struct cache *cache;
    kvsroot_mgr_t *krm;
    kvstxn_mgr_t *ktm;
...
void kvstxn_process_follow_symlink_namespace (void)
{
    struct cache *cache;
    kvsroot_mgr_t *krm;
    kvstxn_mgr_t *ktm;
...
void kvstxn_namespace_prefix_symlink (void)
{
    ...
    root = treeobj_create_dir ();
    _treeobj_insert_entry_val (root, "val", "42", 2);
    _treeobj_insert_entry_symlink (root, "symlink2A", NULL, "ns:A/.");
    _treeobj_insert_entry_symlink (root, "symlink2Achain", NULL, "ns:A/ns:A/.");
    _treeobj_insert_entry_symlink (root, "symlink2B", NULL, "ns:B/.");
...
int main (int argc, char *argv[])
{
    ...
    kvstxn_process_follow_symlink_no_namespace ();
    kvstxn_process_follow_symlink_namespace ();
