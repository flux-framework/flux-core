...
{
    json_t *symlink = treeobj_create_symlink (namespace, target);
...
void lookup_namespace_prefix_symlink (void) {
    ...
    rootA = treeobj_create_dir ();
    _treeobj_insert_entry_val (rootA, "val", "1", 1);
    _treeobj_insert_entry_symlink (rootA, "symlink2BAD", NULL, "ns:A/");
    _treeobj_insert_entry_symlink (rootA, "symlink2chain", NULL, "ns:A/ns:B/.");
    _treeobj_insert_entry_symlink (rootA, "symlink2A", NULL, "ns:A/.");
    _treeobj_insert_entry_symlink (rootA, "symlink2B", NULL, "ns:B/.");
    _treeobj_insert_entry_symlink (rootA, "symlink2A-val", NULL, "ns:A/val");
    _treeobj_insert_entry_symlink (rootA, "symlink2B-val", NULL, "ns:B/val");
    treeobj_hash ("sha1", rootA, root_refA, sizeof (root_refA));
...
void lookup_namespace_prefix_symlink_security (void) {
    ...
    _treeobj_insert_entry_val (rootA, "val", "1", 1);
    _treeobj_insert_entry_symlink (rootA, "symlink2B", NULL, "ns:B/.");
    _treeobj_insert_entry_symlink (rootA, "symlink2C", NULL, "ns:C/.");
    treeobj_hash ("sha1", rootA, root_refA, sizeof (root_refA));
...
void lookup_stall_namespace_prefix_in_symlink (void) {
    ...
    rootA = treeobj_create_dir ();
    _treeobj_insert_entry_val (rootA, "val", "1", 1);
    _treeobj_insert_entry_symlink (rootA, "symlink", NULL, "ns:B/.");
    treeobj_hash ("sha1", rootA, root_refA, sizeof (root_refA));
