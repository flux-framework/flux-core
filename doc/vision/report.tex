...
(HPC). It is the centerpiece that allows efficient executions of HPC applications
...
together with grid management software such as MOAB~\cite{MOAB:online}.  
After a decade of such use of SLURM and of accruing violations of many fundamental
technical assumptions, however, it has become no longer cost effective, if not
impossible, to address newly emerging challenges without sacrificing its
...
These areas are called: {\bf{\em Resource Management}}, {\bf{\em Provenance and Monitoring}},
{\bf{\em Workload Runtime And Placement}}, and {\bf{\em Framework}}.
They are relatively independent but can significantly build on the strength of one
another through well-known interfaces and common design and development
principles. Thus, reaching all major milestones of these thrust areas 
