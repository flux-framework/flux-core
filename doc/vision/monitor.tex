\section{Monitoring and Data Management}

This section describes the input data management and system monitoring
components of \ngrm.
By coupling these systems to the resource manager, we achieve our goals
of mitigating system noise, improving job launch time, and promoting
reproduceability and data provenance.
