...
\fbox{\includegraphics[scale=0.05]{../fig/comms_ex1a.eps}}
\end{minipage}
\hspace{0.5cm}
\begin{minipage}[b]{0.2\linewidth}
\fbox{\includegraphics[scale=0.05]{../fig/comms_ex1b.eps}}
\end{minipage}
\hspace{0.5cm}
\begin{minipage}[b]{0.2\linewidth}
\fbox{\includegraphics[scale=0.05]{../fig/comms_ex1c.eps}}
\end{minipage}
\hspace{0.5cm}
\begin{minipage}[b]{0.2\linewidth}
\fbox{\includegraphics[scale=0.05]{../fig/comms_ex1d.eps}}
\end{minipage}
...
The CMB architecture is depicted in Figure~\ref{FigCommsEx1}.
