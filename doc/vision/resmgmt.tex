...
\ifcomments
\marginpar{\tiny {\bf jeff-review:}
Any advantage/possibility in leveraging LC's LDAP for this?}
...
how is long-term storage managed, especially if users decide
they want to store a movie or data file as part of the permanent record?
{\bf jeff-review:}
To do (data provenance) "right", each job would have to have
...
is unique?
{\bf jeff-review:}
Currently SLURM bogs down if a person does an
...
Plugins described in scheduling section seem like they are
...
\ifcomments
\marginpar{\tiny {\bf chris-review:}
Why are "job prioritization" and "job scheduling" independent
...
\ifcomments
\marginpar{\tiny {\bf chris-review:}
There should be multiple levels of preemptability.}
\fi
If users can add their own data to the provenance database,
