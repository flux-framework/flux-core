...
Why did they choose to do it that way?  Maybe to avoid entanglements
getting IP multicast to work in some environments?}
\fi
...
\ifcomments
\marginpar{\tiny {\bf jg:}
The overall fault tolerance strategy in the comms layer needs some work.
It also needs to be called out in the WBS as a significant R\&D activity.}
\fi
