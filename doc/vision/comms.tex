...
%\begin{figure}
%\centering
%\includegraphics[scale=0.35]{zmqtbon}
...
\end{minipage}
\caption{\zMQ\ provides a socket-like API that supports several
messaging patterns including REQ-REP, PUB-SUB, and PUSH-PULL.
These basic patterns are complemented by features for implementing
