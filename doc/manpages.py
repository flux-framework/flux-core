...
man_pages = [
    ...
    ('man1/flux-gc', 'flux-gc', 'Online garbage collection for KVS content', [author], 1),
    ...
    ('man3/flux_get_conf', 'flux_get_conf', 'get config cache', [author], 3),
    ('man3/flux_get_conf', 'flux_set_conf_new', 'set config cache', [author], 3),
    ('man3/flux_module_set_running', 'flux_module_set_running', 'set module to RUNNING state early', [author], 3),
    ('man3/flux_module_set_running', 'flux_module_debug_test', 'query/clear module debug flags', [author], 3),
    ('man3/flux_module_set_running', 'flux_module_config_request_decode', 'decode config request', [author], 3),
    ('man3/flux_conf_builtin_get', 'flux_conf_builtin_get', 'fetch compiled-in parameters', [author], 3),
    ...
    ('man3/flux_conf_create', 'flux_conf_copy', 'manipulate config objects', [author], 3),
    ...
    ('man7/flux-shell-plugins', 'flux-shell-plugins', 'Flux shell plugin interfaces', [author], 7),
    ('man7/flux-shell-options', 'flux-shell-options', 'Flux shell built-in options', [author], 7),
