...
test_expect_success 'kvs: reload kvs with bad rootref' '
	flux module reload kvs initial-rootref="abcdefghijklmnop"
'

test_expect_success 'kvs: is borked with bad initial rootref' '
	test_must_fail flux kvs get data &&
	test_must_fail flux kvs put a=1
'
