...
test_expect_success 'jj-reader: wrong count type throws error' '
	...
	test_cmp expected.$test_count out.$test_count
'
test_expect_success 'jj-reader: unexepected type continues without error' '
...
#
cat <<EOF >inputs2.txt
use_case_1.4.json ==nnodes=4 nslots=4 slot_size=? slot_gpus=0 exclusive=true duration=0.0
use_case_1.5.json ==nnodes=2 nslots=2 slot_size=1 slot_gpus=0 exclusive=true duration=0.0
use_case_1.6.json ==nnodes=2 nslots=1 slot_size=1 slot_gpus=0 exclusive=true duration=0.0
use_case_1.7.json ==nnodes=3 nslots=1 slot_size=1 slot_gpus=0 exclusive=true duration=0.0
use_case_1.8.json ==nnodes=2 nslots=1 slot_size=1 slot_gpus=0 exclusive=true duration=0.0
