...
# N.B. kvs module reloaded to avoid errors where some modules expect
# kvs to be up on teardown
test_expect_success 'fix corrupted kvs' '
	sudo -u flux flux start --recovery "flux module remove kvs; flux fsck --repair; flux module load kvs"
'
