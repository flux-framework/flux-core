...
static kvsdir_t kvsdir_create (cmb_t c, const char *key, json_object *o)
{
...
{
    return cmb_kvsdir_isint (dir, name); /* no way to distinguish from int */
}
