...
/* Munge/unmunge a one or two part zmsg.
 * The expected use is for flux events, which are generally two part
 * messages consisting of topic string + json.  The encoded message
 * is the topic string (in the clear) and munge_encode(zmsg_encode (*zmsg))
 * as the second part.
 */
